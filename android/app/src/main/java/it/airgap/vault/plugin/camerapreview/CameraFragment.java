...
public class CameraFragment extends Fragment {
  ...
  private boolean tapToTakePicture;
  private boolean dragEnabled;
  private boolean tapToFocus;
  private boolean disableExifHeaderStripping;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    view = inflater.inflate(getResources().getIdentifier("fragment_camera", "layout", appResourcesPackage), container, false);
    createCameraPreview();
    return view;
  }

  public void setParams(String defaultCamera, boolean disableExifHeaderStripping) {
    this.defaultCamera = defaultCamera;
    this.tapToTakePicture = false;
