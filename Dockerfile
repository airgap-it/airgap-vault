...
RUN apt-get update && apt-get install -y wget --no-install-recommends \
  ...
  && apt-get update \
  && apt-get install -y google-chrome-unstable fonts-ipafont-gothic fonts-wqy-zenhei fonts-thai-tlwg fonts-kacst  libglu1 ttf-freefont libxss1 libglib2.0-0 libxshmfence-dev \
